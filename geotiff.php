...
class ImageFileDirectory {
    ...
    public function info() {
        return array(
            'format'    => $this->GeographicTypeGeoKey,
            'bits'      => $this->BitsPerSample,
            'tiepoint'  => array(
                'top'       => $this->ModelTiepointTag[0],
                'left'      => $this->ModelTiepointTag[1],
                'top_lon'   => $this->ModelTiepointTag[3],
                'left_lat'  => $this->ModelTiepointTag[4],
                'scale_x'   => $this->ModelPixelScaleTag[0],
                'scale_y'   => $this->ModelPixelScaleTag[1],
            ),
            'tiles'     => array(
                'width'     => $this->TileWidth,
                'height'    => $this->TileLength,
                'rows'      => $this->TileRowNum,
                'columns'   => $this->TileColumnNum,
                'count'     => $this->TileRowNum * $this->TileColumnNum,
            ),
        );
    }
    ...
    public static $mKernels = array(
        ...
        'blur' => array(
            0.11111111111, 0.11111111111, 0.11111111111,
            0.11111111111, 0.11111111111, 0.11111111111,
            0.11111111111, 0.11111111111, 0.11111111111,
        ),
        'v-sobel' => array(
...
class GeoTIFF {
    ...
    private static $CacheExpire = 3600; /* Cache expiration time in seconds */
    ...
    public function getCurrentIFD() {
        // Assume that there is only one IFD for now
        reset( $this->IFDList );
